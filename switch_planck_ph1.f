*     switch_planck_ph0: version that runs at source phase = 1 only
...
* output files 
*
         open(9,file='big_G_W_out_ph1.txt',status='unknown')
         open(10,file='big_G_W_phase_ph1.txt',status='unknown')
         open(11,file='big_G_inside_points_ph1.txt',status='unknown')
         open(12,file='big_G_geometry_ph1.txt',status='unknown')
*
* output geometry
*
