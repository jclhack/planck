*     switch_planck_ph0_on: version that runs at source phase = 0 only, masses on (20251003)
*     switch_planck_ph0: version that runs at source phase = 0 only
...
*
      ...
      integer*4 jj              ! phase counter for this run         
*
...
*
      ...
      pflag = 1                 ! set to 1 for disk masses
*	
      throws=50000
      games=80
      phpnts=8
...
* input file
* 
      open(20,file='big_G_input_planck.txt',status='unknown')
*
      do 999 u = 1,1
...
*	  
         ...
         shape2(15)=0           ! 
*
         shape2(18)=5080.0/2.0 + 1000.0 + ushape218 ! source cylinder x-position (rel. to source zero)
         shape2(19)=shape1(2)/2.0-shape1(18) + ushape219 ! source cylinder y-position (rel. to source zero)
*	  
...
* output files 
*
         open(9,file='big_G_W_out_ph0.txt',status='unknown')
         open(10,file='big_G_W_phase_ph0.txt',status='unknown')
         open(11,file='big_G_inside_points_ph0.txt',status='unknown')
         open(12,file='big_G_geometry_ph0.txt',status='unknown')
*
* output geometry
*
